    ...
    return (
        <div className='about-container'>
            ...
            <div className='about-text-containers'>
                <div className='text'>
                    We are a family-run business dedicated to sourcing and exporting exceptional coffee from Colombia to
                    the global market. Our focus is solely on Colombia, where we explore the diverse regions and build
